...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221007_throne_9e6758f162c19fb83325_20221007111651_archive.zip';
        const ARCHIVE_SIZE       = '71209277';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '9e6758f-07111651';
        const SECONDARY_PACKAGE_HASH = '7b1e0e6-07111651';
        const VERSION            = '1.5.0';
